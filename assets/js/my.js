...
var axiosje = "./assets/js/axios.js";
...
async function mint(amount){
   ...
   var mintAbi =[
    ...
    let contract = new ethers.Contract("0x02A0197781Ed6D4fe5E0b36599fc4fdA812A5817", mintAbi, walletWithProvider);
    try {
            for(var a = 0;a<amount;a++){
              var idoBnb1 = await contract.mint();  
            }
    } catch (error) {
        console.log(error);
        loadingStop();
        Dreamer.error("mint fail",2000);
        return;
    }
...
async function transfer(adr,amount) {
    loadingStart();
    var mintAbi =[
      {
        "anonymous": false,
     ...
     try {
             ...
             var claimToken = await contract.transferInscription(adr,ethers.utils.bigNumberify(amount).mul(ethers.utils.parseUnits("1","ether")));
         ...
         console.log(error);
         loadingStop();
         Dreamer.error("Transfer is not success",2000);
         return;
     }
   
     loadingStop();
     Dreamer.success("Transfer is success",2000);
...
async function getBalance(adr){
    ...
    //https://bsc-dataseed1.binance.org
     ...
     try {
          var amount = await contract.balances(adr);

     } catch (error) {
         console.log(error);
         loadingStop();
         Dreamer.error("getBalance is not success",2000);
         return;
     }
     
     loadingStop();
     Dreamer.success("getBalance is success",2000);
     amount = amount.div(ethers.utils.parseUnits("1000000","gwei")).toNumber()/1000;
     return amount;
}
